...
Скоро будут добавлены: `horoshop-content-fill` (заполнение пустых полей карточек), `horoshop-photo-audit` (количество и качество фото), `horoshop-text-quality` (опечатки, AI-стоп-слоп), и другие.
